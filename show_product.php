...
if(mysqli_num_rows($result)>0){
    ...
    echo "<td><img src=".$row["pic"]." width=69 height=105></td>";
...
echo "<table border=1><tr><th>ลำดับ</th><th>id</th><th>name</th><th>description</th><th>price</th><th>pic</th>></tr>";
    for($i=0;$i<count($_SESSION["cart"]);$i++)
    {
        ...
        echo "<td><img src=".$item["pic"]." width=69 height=105></td>";
        echo "<td><a href='del_cart.php?i=".$i."'>";
        echo "<font color='red'>นำออกจากตระกร้า</font></a></td></tr>";
        $total+=$item['price'];
    }
echo "</table>";
echo "<button><a href='del_all_cart.php'>นำสินค้าทั้งหมดออกจากตระกร้า</a></button>";
